...
- gerar recomendacoes por diferentes criterios, incluindo `misto`, `confronto_hibrido` e `valorizacao`
...
- `GET /recomendacoes?criterio=valorizacao`
- `GET /recomendacoes?criterio=valorizacao&preco_max=10`
